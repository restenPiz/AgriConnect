...
class _myProductState extends State<myProduct> {
  ...
  // final String apiUrl = 'http://10.148.161.12:8000/api/';
  ...
  Future<void> _fetchProducts() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://10.148.161.12:8000/api/product/$userId'),
  ...
  Future<void> _deleteProduct(int id) async {
    ...
    try {
      final response = await http.delete(
        Uri.parse('http://10.148.161.12:8000/api/productDelete/$id'),
        headers: {'Accept': 'application/json'},
      );
  ...
  Future<void> _toggleProductStatus(int id) async {
    ...
    try {
      final response = await http.put(
        Uri.parse('http://10.148.161.12:8000/api/products/$id'),
        headers: {
  ...
  Widget _buildProductCard(Map<String, dynamic> product) {
    ...
    final imageUrl = imageUrls != null && imageUrls.isNotEmpty
        ? 'http://10.148.161.12:8000${imageUrls[0]}'
        : null;
